...
def sample_dataloader(dataloader, num_samples, batch_size, root, dataset,num_workers):
    """
    ...
    sample = wrap_data(data, targets, batch_size, root, dataset,num_workers)

    return sample, sample_index


def wrap_data(data, targets, batch_size, root, dataset,num_workers):
    """
    ...
    class MyDataset(Dataset):
        ...
        def __getitem__(self, index):
            if self.dataset == 'cifar10':
                ...
                # 为了计算交叉熵损失
                self.targets = self.onehot_targets
            else:
